...
--attribute-definitions AttributeName=teamId,AttributeType=N AttributeName=score,AttributeType=N AttributeName=gameId,AttributeType=N AttributeName=date,AttributeType=N AttributeName=time,AttributeType=N \
...
--global-secondary-indexes '[
       ...
       { "IndexName":"date_time_idx", "KeySchema":[ { "AttributeName":"date", "KeyType":"HASH" }, { "AttributeName":"time", "KeyType":"RANGE" } ], "Projection":{ "ProjectionType":"ALL" }, "ProvisionedThroughput":{ "ReadCapacityUnits":10, "WriteCapacityUnits":10 } }
]'
